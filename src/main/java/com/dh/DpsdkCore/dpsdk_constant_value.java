...
@param DPSDK_CORE_POINT_COUNT				= 200;			预置点数量
@param DPSDK_CORE_POINT_NAME_LEN        	= 128;        	预置点名称长度
...
@param DPSDK_CORE_BAY_IMG_PATH_LEN			= 256;			卡口图片文件路径长度
...
{ 
	...
	public static final int DPSDK_CORE_POINT_COUNT					= 200;						// 预置点数量
	public static final int DPSDK_CORE_POINT_NAME_LEN              	= 128;                      	// 预置点名称长度
	...
	public static final int DPSDK_CORE_BAY_IMG_PATH_LEN			    = 256;						// 卡口图片文件路径长度
	...
	public static final int DPSDK_CORE_CHAR_LEN_128					= 128;
}