...
//				System.out.println("Traffic TruckForbid Event received.");
//                // 路口事件，抓拍车牌
//                DEV_EVENT_TRAFFICTRUCKFORBID_INFO trafficTruckForbid = new DEV_EVENT_TRAFFICTRUCKFORBID_INFO();
//                // 获取车牌信息
//                ToolKits.GetPointerDataToStruct(pAlarmInfo, 0, trafficTruckForbid);
//                String date = trafficTruckForbid.UTC.toStringTime();
//                NetSDKLib.DEV_EVENT_TRAFFIC_TRAFFICCAR_INFO trafficCar = trafficTruckForbid.stTrafficCar;
//                System.out.println(date + " traffic number:" + new String(trafficCar.szPlateNumber, Charset.forName("GBK"))
//                        + ",plate color:" + new String(trafficCar.szPlateColor, Charset.forName("GBK")));
//                // save the picture
//                String imageName = "trafficTruckForbid_" + trafficTruckForbid.UTC.toStringTitle() + ".jpg";
//                String savePath = picturePath + "/" + imageName;
//
//                ToolKits.savePicture(pBuffer, dwBufSize, savePath);
//                System.out.println("save picture to " + savePath);
