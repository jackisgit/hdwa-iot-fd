...
import com.netsdk.lib.enumeration.EM_CHANNELS_STATE_TYPE;
...
//    }
    ...
    public NET_OUT_GET_AREAS_STATUS getAlarmregionInfoChannelsstate() {
        ...
        try {
            ...
            Boolean bRet = netsdk.CLIENT_GetAlarmRegionInfo(
                    loginHandle, NET_EM_GET_ALARMREGION_INFO.NET_EM_GET_ALARMREGION_INFO_AREASTATUS, inputPointer, outPutPointer, 3000);
            if (!bRet) {
